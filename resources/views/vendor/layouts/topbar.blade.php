		 ...
		 @foreach($user->notifications as $notification)
			...
			<div class="user-box dropdown">
				<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
					<img src="{{!empty($vendorData->photo)? url('upload/vendor-images/'.$vendorData->photo):url('upload/no-image.jpg')}}" class="user-img" alt="user avatar">
				...
				<ul class="dropdown-menu dropdown-menu-end">
					...
					<li><a class="dropdown-item" href="{{Route('vendor.vendor_password_change')}}"><i class="bx bx-cog"></i><span>Change Password</span></a>
					</li>
