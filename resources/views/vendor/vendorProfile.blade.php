                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{!empty($vendorData->photo)? url('upload/vendor-images/'.$vendorData->photo):url('upload/no-image.jpg')}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                    <div class="mt-3">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{Route('vendor.profile.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                        <select class="form-select mb-3" aria-label="Default select example" name="join_date">
                                            <option value="">Enter join date</option>
                                            @if(($vendorData->join_date) !== '')
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Short Intro</h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                        <textarea class="form-control" name="short_desc" minlength="50" maxlength="250" id="inputAddress" placeholder="Short Description ..." rows="3">{{$vendorData->short_desc}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img src="{{!empty($vendorData->photo)? url('upload/vendor-images/'.$vendorData->photo):url('upload/no-image.jpg')}}" id="showImage" alt="Admin" width="110">
                                        </div>
                                    </div>
                                    <div class="row">
