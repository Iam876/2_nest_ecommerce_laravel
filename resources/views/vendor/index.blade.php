			...
			<div class="page-content">
				...
				<div class="col-md-4">
					<div class="alert alert-danger" role="alert">
						<strong class="h5 text-danger">Inactive! </strong> Your Account is not Active Yet
						<hr>
						<p class="mb-0">Please wait for admin, Once account active you can perform actions</p>
					</div>
				</div>
				@else
				<div class="col-md-4">
					<div class="alert alert-success alert-dismissible fade show" role="alert">
						<strong class="h5 text-success">Active!</strong> Your Account is Active Now.
