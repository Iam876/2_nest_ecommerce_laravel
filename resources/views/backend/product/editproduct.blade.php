          ...
          <div class="card">
            <div class="p-4">
                <h5 class="card-title">Update Main Image Thumbnail</h5>
                  <hr/>
                  <form action="{{Route('update_mainThumbnail',$products->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
            ...
            <div class="p-4">
                <h5 class="card-title">Update Multi Images</h5>
                  ...
                  <table class="table mb-0 table-striped">
                    ...
                    <tbody>
                  <form action="{{Route('update_multiImages',$products->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @php
                        $id = 1;
                    @endphp
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{Route('delete_multi_images',$mImg->id)}}" class="btn btn-danger btn-sm">DELETE</a>
                        </td>
                    </tr>
                    @endforeach
                  </form>
