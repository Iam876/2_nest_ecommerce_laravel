...
@endsection
    ...
    <main class="main pages">
        <div class="page-content">
				...
				<!--end breadcrumb-->
                <div class="bg-white p-2 w-50 rounded ms-auto">
                    <div class="input-group">
                      <input type="search" id="searchBox" value="" class="form-control rounded" placeholder="Search" aria-label="Search" aria-describedby="search-addon" />
                      <button type="button" class="btn btn-outline-primary" id="SearchUserOrder">search</button>
                    </div>
                  </div>
                <br>
                <br>
