                          ...
                          <div class="row">
                            <div class="col-12 border-top pt-2">
                              ...
                              <div class="mt-2 row">
                                <div class="col-auto me-auto">
                                @if ($order->status == 'pending')
                                    <a href="{{url('pending/confirm/order/'.$order->id)}}" class="btn btn-info btn-sm">
                                    <i class="fa fa-download"></i> Confirm Order </a>
                                @elseif($order->status == 'confirmed')
                                    <a href="{{url('confirmed/processing/order/'.$order->id)}}" class="btn btn-info btn-sm">
                                    <i class="fa fa-download"></i> Processing Order </a>
                                @elseif($order->status == 'processing')
                                    <a href="{{url('processing/delivered/order/'.$order->id)}}" class="btn btn-info btn-sm">
                                    <i class="fa fa-download"></i> Delivered Order </a>
                                @endif
                                </div>
                              </div>
                            </div>
