                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{!empty($adminData->photo)? url('upload/admin-images/'.$adminData->photo):url('upload/no-image.jpg')}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                    <div class="mt-3">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img src="{{!empty($adminData->photo)? url('upload/admin-images/'.$adminData->photo):url('upload/no-image.jpg')}}" id="showImage" alt="Admin" width="110">
                                    </div>
                                </div>
                                <div class="row">
