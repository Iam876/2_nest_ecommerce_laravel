...
<main class="main">
    ...
    <div class="page-content mb-50">
        ...
        <h6 class="mb-10"><a href="#">{{$blog_post->BlogCategory->blog_category_name}}</a></h6>
                ...
                <a class="author-avatar" href="#">
                    <?php 
                        ...
                        foreach ($imagePaths as $imagePath) {
                            $imageFullPath = public_path($imagePath . $user->photo);
                            if (file_exists($imageFullPath)) {
                                $imageUrl = asset($imagePath . $user->photo);
                                break;
                            }
                        }    
                        ?>
                    <img class="img-circle" src="{{asset($imageUrl)}}" alt="" />
                </a>
                <span class="post-by">By <a href="#">{{$user->username}}</a></span>
                <span class="post-on has-dot">{{$timeAgo}}</span>
                <span class="time-reading has-dot">{{$readTime}} mins read</span>
            </div>
    ...
    <div class="col-xl-10 col-lg-12 m-auto">
        ...
        <div class="entry-bottom mt-50 mb-30">
            <div class="tags w-50 w-sm-100">
                ...
                <a href="blog-category-big.html" rel="tag" class="hover-up btn btn-sm btn-rounded mr-10">{{$tags}}</a>                    
                @endforeach
            </div>
            <div class="social-icons single-share">
                <ul class="text-grey-5 d-inline-block">
...
<div class="author-bio p-30 mt-50 border-radius-15 bg-white">
    <div class="author-image mb-30">
        <a href="author.html"><img src="{{asset($imageUrl)}}" alt="" class="avatar" /></a>
        <div class="author-infor">
            <h5 class="mb-5">{{$user->username}}</h5>
            <p class="mb-0 text-muted font-xs">
                <span class="mr-10">{{$postCount}} Posts</span>
                <span class="has-dot">Since {{$user->join_date}}</span>
            </p>
        </div>
    </div>
