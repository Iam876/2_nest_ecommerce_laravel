            ...
            <div class="container">
                <div class="section-title style-2 wow animate__animated animate__fadeIn">
                    ...
                    <ul class="nav nav-tabs links" id="myTab" role="tablist">
                        @php
                            $categories = App\Models\Category\Category::orderBy('id','ASC')->where('status','active')->limit(7)->get();
                        @endphp
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="tab-one" role="tabpanel" aria-labelledby="tab-one">
                        ...
                        @php
                            $products = App\Models\Product\Product::orderBy('product_name','DESC')->where('status',1)->limit(10)->get();
                        @endphp
                    ...
                    <div class="tab-pane fade" id="category{{ $category->id }}" role="tabpanel" aria-labelledby="tab-two">
                        <div class="row product-grid-4">
                    @php
                        $catWiseProduct = App\Models\Product\Product::where('category_id',$category->id)->orderBy('id','DESC')->limit(10)->get();
                    @endphp
