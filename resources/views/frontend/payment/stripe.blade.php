    ...
    <div class="col-lg-6">
        <div class="border p-40 cart-totals ml-30 mb-50">
            ...
            <div class="form-row">
                ...
                <input type="hidden" name="notes" value="{{ $data['shipping_message'] }}">
...
var stripe = Stripe('pk_test_51NJHbBGRDbWrVouIN2dpSzn2LAoKheMVBcfVJi9B8DkRAfYFRc6jbFtdgQz2AAmVZOXW9ytQvfujcLfMgYd4adBx00eMuUEUcM');
