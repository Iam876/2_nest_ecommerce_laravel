            ...
            success: function(response){
                if(response.status==200){
                    ...
                    $.each(response.AllData,function(key,val){
                        ...
                        <td>'+val.banner_url+'</td>\
                        <td><img src="http://127.0.0.1:8000/'+val.banner_image+'" class="" width="60px" alt=""></td>\
                        <td>'+(val.banner_status=='active'?'<button value=\''+val.id+'\' id="Active" class="btn btn-success">Active</button>':'<button value=\''+val.id+'\' id="Inactive" class="btn btn-warning">Inactive</button>')+'</td>\
                        <td>\
    ...
    $(document).on("click","#Edit",function(){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                $("#edit_showImageBanner").attr("src", 'http://127.0.0.1:8000/' + response.success.banner_image);
